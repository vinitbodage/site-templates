...
function buildSlide(row) {
  ...
  const headlineEl = buildPart('div', 'testimonial-headline', [headline]);
  const quoteEl = buildPart('div', 'testimonial-quote', quote);
  const attributionEl = buildPart('footer', 'testimonial-attribution', [attribution]);
