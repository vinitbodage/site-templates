...
function attachLightbox(block, items) {
  ...
  const pauseGridVideos = (pause) => {
    block.querySelectorAll('.mosaic-tile video').forEach((video) => {
 ...
 */
export function decorateMosaic(block) {
